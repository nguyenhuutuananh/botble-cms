...
class TableMakeCommand extends BaseMakeCommand
{
     ...
     * @var string
     */
    protected $signature = 'cms:make:table {name : The table that you want to create} {plugin : Plugin name}';
    ...
    public function handle()
    {
        ...
        $path = plugin_path(strtolower($this->argument('plugin')) . '/src/Tables/' . ucfirst(Str::studly($name)) . 'Table.php');
    ...
    {
        return __DIR__ . '/../../../stubs/package/src/Tables/{Plugin}Table.stub';
    }
