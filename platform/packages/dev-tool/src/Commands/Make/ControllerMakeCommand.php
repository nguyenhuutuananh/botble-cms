...
class ControllerMakeCommand extends BaseMakeCommand
{
     ...
     * @var string
     */
    protected $signature = 'cms:make:controller {name : The table that you want to create} {plugin : Plugin name}';
    ...
    public function handle()
    {
        ...
        $path = plugin_path(strtolower($this->argument('plugin')) . '/src/Http/Controllers/' . ucfirst(Str::studly($name)) . 'Controller.php');
    ...
    {
        return __DIR__ . '/../../../stubs/package/src/Http/Controllers/{Plugin}Controller.stub';
    }
