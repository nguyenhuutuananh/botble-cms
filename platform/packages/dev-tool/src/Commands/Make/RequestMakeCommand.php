...
class RequestMakeCommand extends BaseMakeCommand
{
     ...
     * @var string
     */
    protected $signature = 'cms:make:request {name : The table that you want to create} {plugin : Plugin name}';
    ...
    public function handle()
    {
        ...
        $path = plugin_path(strtolower($this->argument('plugin')) . '/src/Http/Requests/' . ucfirst(Str::studly($name)) . 'Request.php');
    ...
    {
        return __DIR__ . '/../../../stubs/package/src/Http/Requests/{Plugin}Request.stub';
    }
