...
class RouteMakeCommand extends BaseMakeCommand
{
     ...
     * @var string
     */
    protected $signature = 'cms:make:route {name : The table that you want to create} {plugin : Plugin name}';
    ...
    public function handle()
    {
        ...
        $path = plugin_path(strtolower($this->argument('plugin')) . '/routes/' . strtolower($name) . '.php');
    ...
    {
        return __DIR__ . '/../../../stubs/package/routes/web.stub';
    }
